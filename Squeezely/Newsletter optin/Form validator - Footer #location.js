...
function submitForm(submitElement) {
  ...
  if (emailValid === false) {
    ...
    if (submitElement == 'Enter key') {
      _document.querySelector('#sqzl_div-147-99 .szqly-modal-content').classList.add('sqzly-collapse');
      _document.querySelector('#sqzl_div-147-99 .szqly-thankyou').classList.add('sqzly-in');
    }
  }   
}